...
public class ExamController {
    ...
    public String submitExam(Integer paperId, Integer studentId, HttpServletRequest request) {
        ...
        for (QuestionPaper qb : questionPapers) {
            ...
            String[] parameters;
            //如果是多选
            if ("y".equals(qb.getQuestion().getQuestionType())) {
        ...
        for (QuestionPaper qb : questionPapers) {
            ...
            if (qb.getQuestion().getQuestionType().equals("x")) {
                if (StringUtil.isNotEmpty(ans.get(k))) {
    ...
    public String EditExam(Exam exam) throws ParseException {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm");
        Date examBeginDate = dateFormat.parse(exam.getExamBeginDate());
        Date examEndDate = dateFormat.parse(exam.getExamEndDate());
        exam.setExamBegin(examBeginDate);
        exam.setExamEnd(examEndDate);
